      ...
      <div className={`${container.container} ${flex.flexbox}`}>
        ...
        {menu && (
          <nav className={`${styles.menu_nav} animate__animated animate__slideInRight`}>
            <ul>
              <li><Link onClick={scrollToTop} to="/">Inicio</Link></li>
              <li><Link onClick={scrollToTop} to="/Proyectos">Proyectos</Link></li>
              <li><Link onClick={scrollToTop} to="/Galería">Galería</Link></li>
              <li><Link onClick={() => scrollTo("about")} to="/">Nosotros</Link></li>
              <li><Link onClick={() => scrollTo("contactanos")} to="/">Contáctanos</Link></li>
            </ul>
          </nav>
        )}
      </div>
